...
// Função para gerar a lista de todas as avaliações com instruções de como fazer
...
// Função para filtrar as avaliações com base na seleção de fita métrica e/ou goniômetro
function filtrarAvaliacoes() {
    ...
    avaliacoes.forEach(avaliacao => {
        ...
        // Condições de visibilidade com base na seleção de fita métrica e goniômetro
        if ((fitaMetricaSelecionada && instrumento.includes("fitaMetrica")) ||
